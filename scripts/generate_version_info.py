...
FILE_DESCRIPTION = "Battlezone Holo Text Generator"
INTERNAL_NAME = "BZHoloTextGenerator"
ORIGINAL_FILENAME = "BZHoloTextGenerator.exe"
...
def main() -> None:
    ...
    parser.add_argument("--version", required=True, help="Release version, for example 2.1 or v2.1")
